...
if(isset($_POST['submit']))
{
  ...
  {
    $query="INSERT INTO user(role_id,first_name,last_name,email,password,is_emailverified,isactive) VALUES(1,'$fn','$ln','$email','$pwd',0,1)";
