                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="login-form">
                            ...
                            <?php echo $msg; ?>
                            <p id="label3"><span>Already have an account? <a href="login.php">Login</a> </span></p>
                        </div>
                    </div>
                </div>
            </div>
