...
else
{
    if(isset($_POST['save']))
    {
        ...
        $save_query="INSERT INTO seller_note(seller_id, status, title, catagory, display_picture, note_type, number_of_pages, description, university, country, course, course_code, professor, ispaid, selling_price, created_date, created_by, modified_date, modified_by, isactive) VALUES ($uid,6,'$title',$category,'../upload/member/default/default_display.png',$type,'$pages','$desc','$university',$country,'$course','$code','$professor',$mode,'$price',now(),$uid,now(),$uid,1)";
...
if(isset($_POST['publish-yes']))
{
    ...
    $update_get_data=mysqli_query($conn,"UPDATE seller_note SET status=7 WHERE id=$get_id;");
    if(!$update_get_data)
    {
        die(mysqli_error($conn));
    }
            ...
            <div class ="container">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    {?>
                        ...
                        <button name="publish" type="button" onclick="publishModal();">PUBLISH</button> 
                    <?php }else{ ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h6 class="modal-title" id="confirmPublishLabel">Publishing this note will send note to administrator for review, once administrator review and approve then this note will be published to portal.<br><br> Press yes to continue. </h6>
                  </div>
