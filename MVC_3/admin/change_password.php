                        ...
                        <div class="login-form">
                            ...
                            <form id="login-form-field" action="" method="post">
                              <div class="form-group">
                                    ...
                                    <span class="field-icon"><img src="img/all/eye.png" toggle="#old-pwd"  class="toggle-password"></span>
                              </div>
                              <div class="form-group">
                                    <label>New Password</label>
                                    <input id="txtNewPassword" type="password" class="form-control" name="newpwd" placeholder="Password" >
                                    <span class="field-icon"><img src="img/all/eye.png" toggle="#new-pwd"  class="toggle-password"></span>
                              ...
                              <div class="form-group">
                                    ...
                                    <span class="field-icon"><img src="img/all/eye.png" toggle="#confirm-pwd"  class="toggle-password"></span>
                              </div>
