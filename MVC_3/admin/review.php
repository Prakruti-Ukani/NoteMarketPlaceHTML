...
$review_query=mysqli_query($conn,"SELECT r.id,r.reviewby_id,r.comments,r.rating,u.first_name,u.last_name,up.profile_picture FROM seller_note_review r LEFT JOIN user u ON r.reviewby_id=u.id LEFT JOIN user_profile up ON up.user_id=u.id  WHERE r.note_id=$note_id AND r.isactive=1");
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10" style="margin-left: 30px;margin-top: -15px;font-family: 'Open Sans';">
                              <div style="display: flex;">
                                <h3><?php echo $review_row['first_name']." ".$review_row['last_name']; ?></h3>
                                      <div style="position: absolute;right: 40px;margin-top: 20px;"><a href="delete_review.php?review_id=<?php echo $review_row['id'] ?>&note_id=<?php echo $note_id ?>"><img src="img/all/delete.png?review_id=<?php echo $review_row['id']; ?>"></a>
                                      </div>
                              </div>
