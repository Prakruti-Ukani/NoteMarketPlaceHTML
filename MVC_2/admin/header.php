                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="notesLink">
                                            ...
                                            <a class="dropdown-item" href="notes_report.php">Published Notes</a>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="notesLink">
                                            <a class="dropdown-item" href="manage_configuration.php">Manage System Configuration</a>
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        <img src="img/all/reviewer-1.png" role="button"  data-toggle="dropdown" aria-haspopup="true"aria-expanded="false">
