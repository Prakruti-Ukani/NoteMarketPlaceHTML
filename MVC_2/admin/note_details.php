                                    ...
                                    <tr>
                                      ...
                                      <td class="right">
                                        <div class="stars">
                                          ...
                                          <img src="img/all/star.png">
                                          <img src="img/all/star.png">
                                          <img src="img/all/star-white.png">
                                            100 Reviews
                                        </div>
                              ...
                              <div class="col-md-12">
                                  ...
                                  <div class="content">
                                    ...
                                    <div class="content-1">
                                      <div class="row">
                                        <div class="col-md-2 col-sm-2 col-12">
                                          <img src="img/all/reviewer-1.png" class="profile-img">
                                        </div>
                                    ...
                                    <div class="content-2">
                                      <div class="row">
                                        <div class="col-md-2 col-sm-2 col-12">
                                          <img src="img/all/reviewer-2.png" class="profile-img">
                                        </div>
                                        <div class="col-md-10 col-sm-10 col-12">
                                          <div class="row">
                                            <div class="col-md-10 col-10">
                                    ...
                                    <div class="content-3">
                                      <div class="row">
                                        <div class="col-md-2 col-sm-2 col-12">
                                          <img src="img/all/reviewer-3.png" class="profile-img">
                                        </div>
                                        <div class="col-md-10 col-sm-10 col-12">
                                          <div class="row">
