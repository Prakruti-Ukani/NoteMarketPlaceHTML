...
<?php 
        if(isset($_SESSION['login']))
        {
			...
			$user_data=mysqli_query($conn,"SELECT * FROM user WHERE email='$sessionemail'");
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                        ...
                                        { ?>
                                        	<input type="text" class="form-control" id="fn" name="fn" placeholder="Enter your Full name" required  value="<?php echo $fn." ".$ln ?>">
                                        <?php }else{ ?>
                                ...
                                <div class="form-group">
                                        ...
                                        <?php if(isset($_SESSION['email']))
                                        { ?> 
                                        	<input type="email" class="form-control" id="email" name="email" placeholder="Enter your email address" required value="<?php echo $sessionemail ?>" >
                                        <?php }else{ ?>
